        ...
        <table class="table table-striped table-borderd table_sticky">
            <thead>
                <tr>
                    ...
                    <th class ="fixed02" scope="col" >01月</th>
                    <th class ="fixed02" scope="col" >02月</th>
                    <th class ="fixed02" scope="col" >03月</th>
                    <th class ="fixed02" scope="col" >04月</th>
                    <th class ="fixed02" scope="col" >05月</th>
                    <th class ="fixed02" scope="col" >06月</th>
                    <th class ="fixed02" scope="col" >07月</th>
                    <th class ="fixed02" scope="col" >08月</th>
                    <th class ="fixed02" scope="col" >09月</th>
                    <th class ="fixed02" scope="col" >10月</th>
                    <th class ="fixed02" scope="col" >11月</th>
                    <th class ="fixed02" scope="col" >12月</th>
                    {{-- <th scope="col" >操作</th> --}}
                </tr>
            </thead>
                        ...
                        @switch ($progrecheck->check_02)
                            @case (1)   {{-- ― --}}
                                @if($nowmonth >= 2 )
                                    <td class ="text-danger text-center">〇</td>
                                @else
                                    <td class ="text-primary text-center">〇</td>
                                @endif
                                @break;
                            @case (2)   {{-- △ --}}
                                @if($nowmonth >= 2 )
