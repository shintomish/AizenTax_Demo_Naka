        ...
        <table class="table table-striped table-borderd">
            <thead>
                <tr>
                    ...
                    <th scope="col" class ="bg-info text-right">@sortablelink('refnumber',           '整理番号')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('busi_class',          '業務区分')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('business_name',       '社名')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('contents_class',      '内容')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('facts_class',         '顛末')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('proc_date',           '処理日')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('attach_doc',          '添付')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('filing_date',         '提出日')</th>
                    <th scope="col" class ="bg-info text-right">@sortablelink('name',                '担当')</th>
                    ...
                    <script>
                        ...
                        (function($) {
                            ...
                            var indicatorController = {
                                ...
                                $(function(){ h5.core.controller('#container1', indicatorController)});
                            })(jQuery);
                        //---------------------------------------------------------------
                        //-- 削除ボタン押下イベントハンドラ
                        //---------------------------------------------------------------
