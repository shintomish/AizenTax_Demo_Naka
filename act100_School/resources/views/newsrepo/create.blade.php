...
<div class="content-wrapper">
    ...
    {{-- <img src="{{ asset('storage/mail_attachments/line.jpg') }}" width="100" height="100"> --}}
    {{-- assetの結果: {{ asset('storage/mail_attachments/line.jpg') }} --}}
{{-- <a class="nav-link" href="{{route('newsshow','line.jpg')}}">{{ asset('storage/mail_attachments/line.jpg') }}</a> --}}
