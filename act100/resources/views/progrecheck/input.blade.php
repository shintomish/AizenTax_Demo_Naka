        ...
        <table class="table table-responsive text-nowrap table-striped table-borderd table_sticky">
            <thead>
                <tr>
                    ...
                    <th scope="row" class ="fixed02" >01月</th>
                    <th scope="row" class ="fixed02" >02月</th>
                    <th scope="row" class ="fixed02" >03月</th>
                    <th scope="row" class ="fixed02" >04月</th>
                    <th scope="row" class ="fixed02" >05月</th>
                    <th scope="row" class ="fixed02" >06月</th>
                    <th scope="row" class ="fixed02" >07月</th>
                    <th scope="row" class ="fixed02" >08月</th>
                    <th scope="row" class ="fixed02" >09月</th>
                    <th scope="row" class ="fixed02" >10月</th>
                    <th scope="row" class ="fixed02" >11月</th>
                    <th scope="row" class ="fixed02" >12月</th>
                    <th scope="row" >操作</th>
                </tr>
            </thead>
