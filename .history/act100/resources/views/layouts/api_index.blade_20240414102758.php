                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        @switch ($common_no)
                            ...
                            @case ('linetrialuser')
                                ...
                                <h3>体験者名簿・領収書作成 </h3>
                                <div class="col-2">
                                    <a type="submit" class="btn btn-primary btn-sm" href="{{ route('linetrialuser.create')}}">新規</a>
                                    <a type="submit" class="btn btn-success btn-sm" href="{{ route('linetrialuser.input')}}">更新</a>                                </div>
                                @break;
                        ...
                        <div class="btn-group me-2 mb-0">
                            <a style="" class="btn btn-primary btn-sm" href="{{ route('billdata_down') }}">
                                ...
                                一括ダウンロード</a>
                                    ...
                                    @else
                                        @if( $common_no == '00_3' || $common_no == 'linetrialuser' || $common_no == 'linetrialuserhistory'|| $common_no == 'linetrialuser' )
                                        @else
