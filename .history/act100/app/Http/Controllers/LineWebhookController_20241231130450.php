...
class LineWebhookController extends Controller
{
    ...
    private function replyNormalQuery($replyToken)
    {
        ...
        $buttonTemplate = new ButtonTemplateBuilder(
            ...
            [
                new MessageTemplateActionBuilder('ご注文について', ''), // ボタンの表示名とアクション内容
                new MessageTemplateActionBuilder('配送について', 'アクション1'), // ボタンの表示名とアクション内容
                new MessageTemplateActionBuilder('価格について', 'アクション1'), // ボタンの表示名とアクション内容
                new MessageTemplateActionBuilder('返品・交換について', 'アクション1'), // ボタンの表示名とアクション内容
