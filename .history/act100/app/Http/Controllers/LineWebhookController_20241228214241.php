                ...
                switch ($event['message']['type']) {
                    case 'text':
                        ...
                        if (str_contains($userMessage, '価格')) {
                            //Call to a member function build() on array {"exception":"[object] (Error(code: 0): Call to a member function build() on array at /var/www/html/actver/vendor/linecorp/line-bot-sdk/src/LINEBot/MessageBuilder/FlexMessageBuilder.php:142)
